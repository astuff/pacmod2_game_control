...
private:
  ...
  void VehicleSpeedCb(const pacmod2_msgs::msg::VehicleSpeedRpt::SharedPtr msg);
  void PacmodEnabledCb(const pacmod2_msgs::msg::GlobalRpt::SharedPtr msg);
  void ShiftRptCb(const pacmod2_msgs::msg::SystemRptInt::SharedPtr msg);
  void TurnRptCb(const pacmod2_msgs::msg::SystemRptInt::SharedPtr msg);
  void LightsRptCb(const pacmod2_msgs::msg::SystemRptInt::SharedPtr msg);
  void HornRptCb(const pacmod2_msgs::msg::SystemRptBool::SharedPtr msg);
  void WiperRptCb(const pacmod2_msgs::msg::SystemRptInt::SharedPtr msg);
  ...
  rclcpp::Publisher<pacmod2_msgs::msg::GlobalCmd>::SharedPtr global_cmd_pub_;
  rclcpp::Publisher<pacmod2_msgs::msg::SystemCmdInt>::SharedPtr turn_signal_cmd_pub_;
  rclcpp::Publisher<pacmod2_msgs::msg::SystemCmdInt>::SharedPtr headlight_cmd_pub_;
  rclcpp::Publisher<pacmod2_msgs::msg::SystemCmdBool>::SharedPtr horn_cmd_pub_;
  rclcpp::Publisher<pacmod2_msgs::msg::SystemCmdInt>::SharedPtr wiper_cmd_pub_;
  rclcpp::Publisher<pacmod2_msgs::msg::SystemCmdInt>::SharedPtr shift_cmd_pub_;
  rclcpp::Publisher<pacmod2_msgs::msg::SystemCmdFloat>::SharedPtr accelerator_cmd_pub_;
  rclcpp::Publisher<pacmod2_msgs::msg::PositionWithSpeed>::SharedPtr steering_cmd_pub_;
  rclcpp::Publisher<pacmod2_msgs::msg::SystemCmdFloat>::SharedPtr brake_cmd_pub_;

  rclcpp::Subscription<sensor_msgs::msg::Joy>::SharedPtr joy_sub_;
  rclcpp::Subscription<pacmod2_msgs::msg::VehicleSpeedRpt>::SharedPtr speed_sub_;
  rclcpp::Subscription<pacmod2_msgs::msg::GlobalRpt>::SharedPtr enable_sub_;
  rclcpp::Subscription<pacmod2_msgs::msg::SystemRptInt>::SharedPtr lights_sub_;
  rclcpp::Subscription<pacmod2_msgs::msg::SystemRptBool>::SharedPtr horn_sub_;
  rclcpp::Subscription<pacmod2_msgs::msg::SystemRptInt>::SharedPtr wiper_sub_;
  ...
  bool pacmod_override_active_ = false;
  pacmod2_msgs::msg::VehicleSpeedRpt::SharedPtr veh_speed_rpt_ = NULL;
};
