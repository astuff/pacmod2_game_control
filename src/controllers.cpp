...
int Controller::turn_signal_cmd()
{
  ...
  {
    return pacmod2_msgs::msg::SystemCmdInt::TURN_LEFT;
  }
  // Right on directional pad
  else if (input_msg_.axes[axes_[JoyAxis::DPAD_LR]] == AXES_MIN)
  {
    return pacmod2_msgs::msg::SystemCmdInt::TURN_RIGHT;
  }
  // Down on directional pad
  else if (input_msg_.axes[axes_[JoyAxis::DPAD_UD]] == AXES_MIN)
  {
    return pacmod2_msgs::msg::SystemCmdInt::TURN_HAZARDS;
  }
  else
  {
    return pacmod2_msgs::msg::SystemCmdInt::TURN_NONE;
  }
}
...
int Controller::shift_cmd()
{
  ...
  desired_gear |= (input_msg_.buttons[btns_[JoyButton::RIGHT_BTN]] == BUTTON_PRESSED)
                      << pacmod2_msgs::msg::SystemCmdInt::SHIFT_REVERSE |
                  (input_msg_.buttons[btns_[JoyButton::BOTTOM_BTN]] == BUTTON_PRESSED)
                      << pacmod2_msgs::msg::SystemCmdInt::SHIFT_FORWARD |
                  (input_msg_.buttons[btns_[JoyButton::TOP_BTN]] == BUTTON_PRESSED)
                      << pacmod2_msgs::msg::SystemCmdInt::SHIFT_PARK |
                  (input_msg_.buttons[btns_[JoyButton::LEFT_BTN]] == BUTTON_PRESSED)
                      << pacmod2_msgs::msg::SystemCmdInt::SHIFT_NEUTRAL;

  switch (desired_gear)
  {
    case 1 << pacmod2_msgs::msg::SystemCmdInt::SHIFT_REVERSE:
      return pacmod2_msgs::msg::SystemCmdInt::SHIFT_REVERSE;
    case 1 << pacmod2_msgs::msg::SystemCmdInt::SHIFT_FORWARD:
      return pacmod2_msgs::msg::SystemCmdInt::SHIFT_FORWARD;
    case 1 << pacmod2_msgs::msg::SystemCmdInt::SHIFT_PARK:
      return pacmod2_msgs::msg::SystemCmdInt::SHIFT_PARK;
    case 1 << pacmod2_msgs::msg::SystemCmdInt::SHIFT_NEUTRAL:
      return pacmod2_msgs::msg::SystemCmdInt::SHIFT_NEUTRAL;
    // Invalid command (or multiple buttons pressed)
    default:
      return pacmod2_msgs::msg::SystemCmdInt::SHIFT_NONE;
  }
}
